        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="height35 marTop35 projectContainer d-block d-xl-none col-12">
              ...
              </div><div class="height30 projectContainer col-12 col-xl-4 left anchomobile100">
                <img class="projectInner" src="assets/img/portfolio/yolo/yolo1.png" />
              </div>
              <div class="height30 projectContainer col-12 col-xl-5 left">
                <img class="projectInner" src="assets/img/portfolio/yolo/yolo2.png" />
              </div>
              <div class="height65 projectContainer d-none d-xl-block col-xl-3 left ">
                <img class="projectInner" src="assets/img/portfolio/yolo/yolo6.png" />
              </div>
              <div class="height30 projectContainer d-block d-xl-none col-6 left anchomobile100">
                <img class="projectInner" src="assets/img/portfolio/yolo/yolo6.png">
              </div><div class="height35 marTop35 projectContainer d-none d-xl-block col-xl-6 left">
                <div class="projectInner" onclick="this.nextElementSibling.style.display='block'; this.style.display='none'">  
                  <img class="projectInner" src="assets/img/portfolio/yolo/yolo3.png" />
                </div>
                <div class="youtube-video-container" style="display:none">
              ...
              <div class="projectContainer marTop35 height35 d-none d-xl-block col-xl-3 col-6 left projectDescription">
              ...
              <div class="height30 projectContainer d-block d-xl-none col-6 right">              <img class="projectInner" src="assets/img/portfolio/yolo/yolo7.png" />
                <div class="centerProject"></div>
              </div>
              <div class="height35 projectContainer d-none d-xl-block col-xl-6 left">              <img class="projectInner" src="assets/img/portfolio/yolo/yolo5.png" />
                <div class="centerProject"></div>
              </div><div class="height35 projectContainer col-12 col-xl-6 left">
                <div class="projectInner" onclick="this.nextElementSibling.style.display='block'; this.style.display='none'">  
